...
#     the file store the contour file
    csvpath_all = './feature_train_all.csv'
    ...
    with open(csv_path, newline='') as csvfile:
        ...
        for row in reader:
            ...
            if (i =='0'):
                i = '10'
            img_path_panel = './final_contour/house'+ str(i) +'/panel/' + contour['id'] +'.png'
            img_path_nopanel = './final_contour/house'+ str(i) +'/nopanel/' + contour['id'] +'.png'
            npy_path = './dataset930/house'+ str(i) +'/contour/'
            if (contour['label']=='1'):
                path = img_path_panel
            if (contour['label']=='0'):
